...
#ifndef REMOTEDEBUGGER_SWIFT_H
#define REMOTEDEBUGGER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="RemoteDebugger",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC14RemoteDebugger12NearbyDevice")
@interface NearbyDevice : NSObject
...
@interface NearbyDevice (SWIFT_EXTENSION(RemoteDebugger)) <MCSessionDelegate>
...
SWIFT_CLASS("_TtC14RemoteDebugger13NearbySession")
@interface NearbySession : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
