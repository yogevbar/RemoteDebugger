...
class LYTabItemView: NSButton {
    ...
    var backgroundColor: ColorConfig = [
        .active: NSColor(hex: "#1F1F21FF")!,
        .windowInactive: NSColor(hex: "#1F1F21FF")!,
        .inactive: NSColor(hex: "#1F1F21FF")!
    ]

    var hoverBackgroundColor: ColorConfig = [
        .active: NSColor(hex: "#0E0E0FFF")!,
        .windowInactive: NSColor(hex: "#0E0E0FFF")!,
        .inactive: NSColor(hex: "#0E0E0FFF")!
    ]
    ...
    var selectedBackgroundColor: ColorConfig = [
        .active: NSColor(hex: "#37383AFF")!,
        .windowInactive: NSColor(hex: "#37383AFF")!,
        .inactive: NSColor(hex: "#37383AFF")!
    ]

    var selectedTextColor: ColorConfig = [
        .active: NSColor.white,
        .windowInactive: NSColor.white,
        .inactive: NSColor.white
    ]

    var unselectedForegroundColor = NSColor(hex: "#9B9B9DFF")
        ...
        if let tabViewItem = self.tabViewItem {
            ...
            if #available(OSX 10.15, *) {
                ...
                if self.tabViewItem === self.tabBarView.selectedTabView()?.tabViewItem {
                    NotificationCenter.default.post(name: notification, object: nil, userInfo: userinfo as [AnyHashable : Any])
                }
            } else {
